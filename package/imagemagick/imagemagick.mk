...
IMAGEMAGICK_CONFIGURE_PREFIX=/usr/local
IMAGEMAGICK_CONFIGURE_EXEC_PREFIX=/usr/local

IMAGEMAGICK_LOCAL_CONFIG_SCRIPTS = \
	$(addsuffix -config,MagickCore MagickWand)

ifeq ($(BR2_INSTALL_LIBSTDCPP)$(BR2_USE_WCHAR),yy)
IMAGEMAGICK_LOCAL_CONFIG_SCRIPTS += Magick++-config
endif
else
