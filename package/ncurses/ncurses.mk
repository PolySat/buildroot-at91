...
NCURSES_CONFIGURE_PREFIX=/usr/local
NCURSES_CONFIGURE_EXEC_PREFIX=/usr/local
NCURSES_CONFIG_SCRIPTS_PATH=usr/local/bin/$(NCURSES_CONFIG_SCRIPTS)
NCURSES_LOCAL_CONFIG_SCRIPTS = ncurses$(NCURSES_LIB_SUFFIX)6-config
NCURSES_CONFIG_SCRIPTS_PATH=usr/bin/$(NCURSES_LOCAL_CONFIG_SCRIPTS)
NCURSES_TERMINFO_PATH=usr/local/share
else
NCURSES_CONFIG_SCRIPTS = ncurses$(NCURSES_LIB_SUFFIX)6-config
NCURSES_CONFIG_SCRIPTS_PATH=usr/bin/$(NCURSES_CONFIG_SCRIPTS)
NCURSES_TERMINFO_PATH=usr/share
endif
...
define NCURSES_TARGET_CLEANUP_TERMINFO
	$(RM) -rf $(TARGET_DIR)/$(NCURSES_TERMINFO_PATH)/terminfo $(TARGET_DIR)/$(NCURSES_TERMINFO_PATH)/tabset
	$(foreach t,$(NCURSES_TERMINFO_FILES), \
		$(INSTALL) -D -m 0644 $(STAGING_DIR)/$(NCURSES_TERMINFO_PATH)/terminfo/$(t) \
			$(TARGET_DIR)/$(NCURSES_TERMINFO_PATH)/terminfo/$(t)
	)
endef
